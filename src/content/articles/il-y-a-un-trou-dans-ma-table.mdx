...
<Eval
	rows={[
		'Je suis calme et impliqué·e dans mon travail. Faire preuve d’autonomie, d’initiative, de responsabilité, d’engagement et d’esprit critique dans la conduite d’un projet artistique.',
		'Un spectateur peut penser qu’il y’a vraiment un trou sur la table. Prendre en compte les conditions de la réception de sa production dès la démarche de création.',
	]}
/>
